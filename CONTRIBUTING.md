...
The following is a set of guidelines for contributing to `swiss-army-knife`.
...
This section guides you through submitting a bug report for `swiss-army-knife`. Following these guidelines helps maintainers 
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you started `swiss-army-knife`, 
